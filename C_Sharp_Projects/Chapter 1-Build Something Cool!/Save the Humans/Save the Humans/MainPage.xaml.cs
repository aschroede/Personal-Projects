...
namespace Save_the_Humans
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void Target_PointerEntered(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            ...
            {
                progressBar.Value = 0;
                Canvas.SetLeft(target, random.Next(200, (int)playArea.ActualWidth - 300));
                Canvas.SetTop(target, random.Next(200, (int)playArea.ActualHeight - 200));

                Canvas.SetLeft(human, random.Next(200, (int)playArea.ActualWidth - 200));
                Canvas.SetTop(human, random.Next(200, (int)playArea.ActualHeight - 200));
                humanCaptured = false;
                human.IsHitTestVisible = true;
            }
        }
