...
namespace ExcuseManager2
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            folderBrowserDialog1.SelectedPath = @"D:\Documents\Business\C_Sharp_Projects\Chapter 9\ExcuseManager2\Excuses";
        ...
        private void Random_Click(object sender, EventArgs e)
        {
            if (Directory.GetFiles(selectedFolder).Length == 0)
                MessageBox.Show("There are no excuse ifles in the selected folder.");
